...
gcc -g3 -fsanitize=address sceleton.o verify_or_exit.o instructions.o list_operations.o sortingA.o sortingB.o get_next_line.o get_next_line_utils.o main.o -o push_swap
rm *.o