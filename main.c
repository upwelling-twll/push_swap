...
// int	inst_num(tt_list *stack1, tt_list *stack2, tt_list *node, int size, i_list **inumber)
// {
// 	int position;
// 	tt_list	*heads1;
// 	int	inst_num;
...
// 	i_to_place(node, stack2, inumber, size);
...
// 	while(i < list_size)
// 	{
// 		cur_inst = inst_num(shead, stack2, cur, list_size, &inumber);
// 		if (min > cur_inst)
// 		{
// 			target = cur;
// 			min = cur_inst;
